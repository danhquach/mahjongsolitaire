...
**Tile sets, pulled forward as earned cosmetics (issue #229, 2026-09-05).** Two purchasable glyph sets ship behind a Shop row in Settings, paid for with Daily trophies rather than IAP (decision 0038) — the themes/tile-set item above stays for whatever is *sold*, not earned. Board felts followed the same day as plain colours in the palette table (decision 0039) — no art needed. Tile backs landed once their sheet was generated and cut (decision 0040). Avatar frames are the ticket's last slice.
